  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{gap:10}}>
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>BLOOD SERVICES</Text>
                <Text style={{fontSize:18,textAlign:"justify"}}>The Blood Services is of the only two organizations authorized to collect, screen and issue blood in the country. With the state-of-the-art 
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>DISASTER MANAGEMENT SERVICES</Text>
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>SAFETY SERVICES</Text>
                <Text style={{fontSize:18,textAlign:"justify"}}>
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>HEALTH SERVICES</Text>
                <Text style={{fontSize:18,textAlign:"justify"}}>
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>SOCIAL SERVICES</Text>
                <Text style={{fontSize:18,textAlign:"justify"}}>
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>RED CROSS YOUTH</Text>
                <Text style={{fontSize:18,textAlign:"justify"}}>
            ...
            <View style={{gap:10}}>
                <Text style={{fontSize:18,textAlign:"justify"}}>INTERNATIONAL HUMANITARIAN LAW (IHL)</Text>
                <Text style={{fontSize:18,textAlign:"justify"}}>
