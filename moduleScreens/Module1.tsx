...
const Module1 = () => {
  return (
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Image  style={{width:"100%",height:180}} source={require(`../assets/images/first aid.jpg`)}/>
       
        <Text style={styles.p}>Is an immediate help provided to a sick or injured person until professional medical help arrives or becomes available.</Text>
        ...
        <View style={{width:"100%",backgroundColor:"#7E0303",borderRadius:4, padding:12}}>
            ...
            <View style={{marginTop:25,gap:7}}>
                <Text style={{...styles.p,fontSize:22,fontWeight:"bold"}} >Basic Life Support</Text >
                <Text style={styles.p}>An emergency procedure that consists of recognizing respiratory or cardiac arrest or both and the proper application of CPR to maintain life until a victim recovers or advanced life support is available.</Text>
            </View>

            <Image style={{width:"100%",height:180}} source={require(`../assets/images/Cardiac arrest1.png`)}/>
...
"Abandonment of person in danger and abandonment of one's own victim."</Text>
                    ...
                    <View style={{padding:10, gap:7}}>
                       <Text style={styles.p}>1. Anyone who shall fail to render assistance to any person whom he shall in an uninhabited place wounded or in danger of dying, when he can render such assistance without detriment to himself, unless such omission shall constitute a more serious offense.</Text>
                        <Text style={styles.p}>
                ...
                <Text style={styles.p}>Helping others is not without risks and hazards, most important of which is the risk of contracting an infectious disease. Infectious diseases are those that can spread from one person to another and develop when germs invade the body and cause illness.</Text>
                ...
                <View style={{gap:5,alignItems:"center",marginBottom:20}}>
                    <Image style={{width:"100%",height:180}} source={require(`../assets/images/herpes.jpg`)}/>
                    <Text style={styles.p}>Herpes</Text>
                </View>

                
                <View style={{gap:5,alignItems:"center",marginBottom:20}}>
                    <Image style={{width:"100%",height:180}} source={require(`../assets/images/miningitis.jpg`)}/>
                    <Text style={styles.p}>Meningitis</Text>
                </View>

                <View style={{gap:5,alignItems:"center",marginBottom:20}}>
                    <Image style={{width:"100%",height:180}} source={require(`../assets/images/tuberculosis.jpg`)} />
                    <Text style={styles.p}>Tuberculosis</Text>
                </View>

                <View style={{gap:5,alignItems:"center",marginBottom:20}}>
                    <Image style={{width:"100%",height:180}} source={require(`../assets/images/hepatitis.jpg`)} />
                    <Text style={styles.p}>Hepatitis</Text>
                </View>

                <View style={{gap:5,alignItems:"center",marginBottom:20}}>
                    <Image style={{width:"100%",height:180}} source={require(`../assets/images/hiv.jpg`)} />
                    <Text style={styles.p}>Human Immune Deficiency Virus</Text>
                </View>


            <View style={{gap:7}}>
                <Text style={{fontSize:22,fontWeight:"bold",color:"white "}}>Prevention and Protection</Text>
                <Text style={styles.p}>Universal Precautions are set of strategies developed to prevent transmission of blood borne pathogens. Body Substance Isolation (BSI) are precautions taken to isolate or prevent risk of exposure from body secretions and any other type of body substance such as urine, vomit, faeces, sweat, or sputum. Personal Protective Equipment (PPE) is specialized clothing, equipment and supplies that keep you from directly contacting infected materials.</Text>
            </View>
