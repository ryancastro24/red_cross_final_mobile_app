  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{marginTop:15,gap:7}}>
            <Image style={{width:"100%",height:180,marginTop:20}} source={require(`../assets/images/30.Back blows & Abdominal.jpg`)} />
            <Image style={{width:"100%",height:180,marginTop:20}} source={require(`../assets/images/31..Back blows & Abdominal.jpg`)} />
            <Image style={{width:"100%",height:180,marginTop:20}} source={require(`../assets/images/32.Back blows & Abdominal.jpg`)} />
            <Image style={{width:"100%",height:180,marginTop:20}} source={require(`../assets/images/33..Back blows & Abdominal.jpg`)}/>
        </View>
