  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>HUMANITY</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We serve people but not systems"</Text>
            <Text style={{fontSize:18,textAlign:"center"}}>The International Red Cross and Red Cresent Movement, born of a desire to bring assistance without 
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>IMPARTIALITY</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We serve for the victims and for the aggressor alike"</Text>
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>NEUTRALITY</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We take initiative but never sides"</Text>
            <Text style={{fontSize:18,textAlign:"center"}}>
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>INDEPENDENCE</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We bow to needs but not to kings"</Text>
            <Text style={{fontSize:18,textAlign:"center"}}>
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>VOLUNTARY SERVICE</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We work around the clock  but never for personal gain"</Text>
            <Text style={{fontSize:18,textAlign:"center"}}>
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>UNITY</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We have many talents, but single idea"</Text>
            <Text style={{fontSize:18,textAlign:"center"}}>
               There can only be one Red Cross Society in one community. It must be open to all. It must carry on the humanitarium work throughout its territory
            </Text>
        </View>
        ...
        <View style={{gap:10,marginTop:30}}>
            <Text style={{fontSize:18,textAlign:"center"}}>UNIVERSALITY</Text>
            <Text style={{fontSize:18,fontStyle:"italic",textAlign:"center"}}>"We respect nations, but our work knows no bounds"</Text>
            <Text style={{fontSize:18,textAlign:"center"}}>
