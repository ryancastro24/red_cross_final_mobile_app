...
const ChangePassword = () => {
    ...
    const [showPasswordChangedDisplay,setShowPasswordChangedDisplay] = useState(false);
    ...
    const handleSubmit = () => {
        ...
        fetch('https://red-cross-api-final.onrender.com/api/user/passwordApproval', {
            method: 'POST',
            headers: {
    ...
    return (
        <View style={{ paddingVertical: 40, paddingHorizontal: 20 }}>
            <View>
                ...
                {incorrectPassword && <Text style={{color:"red",fontSize:18,marginTop:10}}>Incorrect Password, Try again!</Text>}
            </View>


            {showChangePassword && <View style={{marginTop:50}}>
                <Text style={{ fontSize: 18, fontWeight: '300' }}>
                    New Password
                </Text>
                <TextInput
                ...
                {showPasswordChangedDisplay && <Text style={{
                    color:"white",
