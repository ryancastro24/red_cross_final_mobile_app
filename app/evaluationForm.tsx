      ...
      <View>
        <View style={styles.detailsContainer}>
          ...
          <View style={{ gap: 1 }}>
            ...
            <Text style={{ fontSize: 15, fontFamily: "Poppins" }}>{field}</Text>
          </View>
        </View>
          ...
          >
            ...
            >
              <View style={{ alignItems: "center", gap: 2 }}>
                ...
                ></View>
                <Text style={{ fontFamily: "Poppins" }}>WORST</Text>
              </View>
              ...
              <View style={{ alignItems: "center", gap: 2 }}>
                ...
                ></View>
                <Text style={{ fontFamily: "Poppins" }}>BAD</Text>
              </View>
              ...
              <View style={{ alignItems: "center", gap: 2 }}>
                ...
                ></View>
                <Text style={{ fontFamily: "Poppins" }}>NEUTRAL</Text>
              </View>
              ...
              <View style={{ alignItems: "center", gap: 2 }}>
                ...
                ></View>
                <Text style={{ fontFamily: "Poppins" }}>GOOD</Text>
              </View>
              ...
              <View style={{ alignItems: "center", gap: 2 }}>
                ...
                ></View>
                <Text style={{ fontFamily: "Poppins" }}>EXCELLENT</Text>
              </View>
            </View>
