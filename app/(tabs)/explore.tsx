...
export default function CertificateDownload() {
  ...
  const getUserAssessmentData = async () => {
    try {
      ...
      const response = await fetch(
        `https://red-cross-api-final.onrender.com/api/userAssessment/${userData._id}`
      );
            ...
            <View style={{ gap: 20, width: "100%", marginTop: 30 }}>
              <View style={{ width: "100%", gap: 5 }}>
                ...
                <ProgressBar
                  ...
                  progress={handleUserAssessmentProgressBar(
                    userAssessment?.firsAid
                  )}
                  color={ratingLabel(userAssessment?.firsAid)}
                />
              </View>
              ...
              <View style={{ width: "100%", gap: 5 }}>
                ...
                <ProgressBar
                  ...
                  color={ratingLabel(userAssessment?.cpr)}
                />
              </View>
              ...
              <View style={{ width: "100%", gap: 5 }}>
                ...
                <ProgressBar
                  style={{ height: 10, borderRadius: 2 }}
                  progress={handleUserAssessmentProgressBar(
                    userAssessment?.pathogen
                  )}
                  color={ratingLabel(userAssessment?.pathogen)}
                />
              </View>
              ...
              <View style={{ width: "100%", gap: 5 }}>
                ...
                <ProgressBar
                  ...
                  color={ratingLabel(userAssessment?.preparedness)}
                />
              </View>
              ...
              <View style={{ width: "100%", gap: 5 }}>
                ...
                <ProgressBar
                  style={{ height: 10, borderRadius: 2 }}
                  progress={handleUserAssessmentProgressBar(
                    userAssessment?.teamwork
                  )}
                  color={ratingLabel(userAssessment?.teamwork)}
                />
              </View>
            </View>
          </View>
