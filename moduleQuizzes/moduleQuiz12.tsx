  ...
  const handleSubmit = async() => {
    ...
    try {
      ...
      const response = await fetch('https://red-cross-api-final.onrender.com/api/modules', {
        ...
        body: JSON.stringify({moduleName:"Module12",totalScore:scoreArr,userId:userData?._id}),
      });
...
<>
    ...
    <View style={{padding:20}}>
        ...
        <View style={{marginBottom:30}}>
          <Text>What are the three types of emergency evacuation drills mentioned?</Text>
  <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      ...
      <Text>Planned Drill, Unplanned Drill, and Service Drills</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Scheduled Drill, Unannounced Drill, and In-Service Drills</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>Morning Drill, Afternoon Drill, and Night Drill</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Practice Drill, Live Drill, and Surprise Drill</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View style={{marginBottom:30}}>
          <Text>Which of the following is a sign of Emergency Childbirth?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>If the woman is calm and relaxed</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>If the woman is straining or pushing down with contractions</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>If the baby is moving gently</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>If labor contractions are more than 10 minutes apart</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View style={{marginBottom:30}}>
          <Text>Which item is NOT listed as a material or supply needed during emergency childbirth?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    ...
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Safety helmet</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>New razor blade</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View style={{marginBottom:30}}> 
          <Text>What is a common cause of drowning according to the module?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>Overeating before swimming</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
    ...
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>Staying too long in the sun</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Wearing too many clothes</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View>
          <Text>What is the recommended action if a victim is submerged in shallow water?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>Dive in immediately without any equipment</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Carefully wade into the water with flotation equipment</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>Call the local emergency number and wait for help</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Ignore the victim and move to a safer location</Text>
    </View>
  </View>
</RadioButton.Group>
...
export default ModuleQuiz12Container