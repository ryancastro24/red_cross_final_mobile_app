  ...
  const handleSubmit = async() => {
    ...
    try {
      ...
      const response = await fetch('https://red-cross-api-final.onrender.com/api/modules', {
        ...
        body: JSON.stringify({moduleName:"Module10",totalScore:scoreArr,userId:userData?._id}),
      });
...
<>
    ...
    <View style={{marginBottom:30}}>
          <Text>What does F.A.S.T stand for in stroke assessment?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Face, Arm, Speech, Time</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>Feet, Alertness, Speech, Temperature</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>Face, Arm, Sensation, Temperature</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Feel, Alert, Speech, Time</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View style={{marginBottom:30}}>
          <Text>Which of the following is NOT a sign of a diabetic emergency?</Text>
  <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 ,paddingRight:40}}>
      <RadioButton value="1" />
      <Text>Sudden numbness or weakness on one side of the body</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2,paddingRight:40 }}>
      <RadioButton value="0-2" />
      <Text>The person may need food or drink containing sugar</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2,paddingRight:40 }}>
      <RadioButton value="0-1" />
      <Text>Person tests their blood glucose level</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2,paddingRight:40 }}>
      <RadioButton value="0-3" />
      <Text>Person may be unconscious or about to lose consciousness</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View style={{marginBottom:30}}>
          <Text>What should you NOT do when assisting someone during a seizure?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>Protect the victim's head with a folded towel</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Restrain the victim to prevent movement</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>Remove nearby objects that could cause injury</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Stay with the victim until they are fully conscious</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View style={{marginBottom:30}}> 
          <Text>Which of the following is a cause of anaphylaxis?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>Standing for long periods</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>An emotional stressful event</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Bee or insect venom</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Sudden numbness or weakness in the face</Text>
    </View>
  </View>
</RadioButton.Group>
        ...
        <View>
          <Text>What is fainting caused by?</Text>
          <RadioButton.Group 
...
>
  <View style={{ justifyContent: "space-evenly", marginTop: 10 }}>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-1" />
      <Text>An allergic reaction</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-2" />
      <Text>Disruption in brain electrical activity</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="1" />
      <Text>Temporary reduction of blood flow to the brain</Text>
    </View>
    <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}>
      <RadioButton value="0-3" />
      <Text>Sudden rise in body temperature</Text>
    </View>
  </View>
</RadioButton.Group>
...
export default ModuleQuiz10Container